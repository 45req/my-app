			...
			<div className="max-w-4xl mx-auto px-4 py-12">
				...
				>
					...
					<p className="text-rose-300/80 max-w-lg">
						At Aromantic, we prioritize your privacy with our minimal data retention approach. Here's everything you need
				...
				>
					...
					<div className="space-y-4 text-rose-200/90 relative">
						<motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
							Aromantic operates on a strict minimal-retention policy. We do not store search queries, search types,
				...
				>
					...
					<div className="space-y-4 text-rose-200/90">
						...
						<p>
							Aromantic uses third-party payment processors. We do not retain any payment data whatsover, as this data is
				...
				>
					...
					<div className="space-y-4 text-rose-200/90">
						<p>
							Aromantic integrates with multiple intelligence and data sources as detailed on our website. These include
