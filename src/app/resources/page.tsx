...
export default function ResourcesPage() {
	const resources: Resource[] = [
		...
		{
			id: "video-tutorials",
			title: "selfbots in 5 hours, full course",
			description: "Awesome course that teaches you a lot about SELFBOTS and other stuff in general.",
			icon: <Video size={18} />,
			category: "video",
			updated: "Jan 10, 2022",
			author: "Aromantic Team",
		...
		{
			id: "client-tools",
			title: "The Impact of selfbots on discord",
			description: "Great article about ethics in selfbotting",
								...
								>
									<div>
										...
										<p className="text-muted-foreground">
											Guides, tutorials and reference materials for selfbotting and Aromantic.
										</p>
