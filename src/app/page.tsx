...
const rotatingWords = [
	{ text: "Auto join giveaway", impact: true },
	{ text: "Friendly UI", impact: true },
	{ text: "Secure", impact: true },
	{ text: "Fast", impact: true },
	{ text: "The best", impact: true },
	{ text: "Join Now", impact: true, glow: true },
]
					...
					>
						...
						<div className="space-y-6">
							...
							>
								...
								>
									The <span className="text-rose-400 font-semibold">ultimate Selfbot</span> with{" "}
								...
								>
									...
									<div className="flex items-center gap-2">
										...
										<span>Instant User interface</span>
									</div>
								</motion.div>
							</motion.div>
						</div>
					...
					>
						<h2 className="text-4xl md:text-5xl font-bold">
							<span className="bg-gradient-to-r from-rose-400 to-rose-600 bg-clip-text text-transparent">
								One Selfbot. Unlimited possibility.
							</span>
						</h2>
						<p className="text-rose-200/80 text-xl max-w-2xl mx-auto leading-relaxed">
							Aromantic.io unifies selfbot features into a single, powerful interface that delivers results in seconds,
							not hours.
						</p>
					</motion.div>
						...
						{[
							{
								...
								description:
									"Your Tokens are never stored. Every session is completely ephemeral for maximum privacy.",
							},
							{
								icon: Database,
								title: "Best Features",
								description:
									"Access the Best collection of Features through one unified interface with instant results.",
							},
							{
								icon: Lock,
								title: "Secure Access",
				...
				<div className="max-w-7xl mx-auto">
					...
					>
						...
						<p className="text-rose-200/80 text-lg max-w-3xl mx-auto">
							Access {providers.length}+ premium Features through one unified interface. New Features are
					...
					>
						...
						<h2 className="text-5xl md:text-6xl font-black">
							<span className="bg-gradient-to-r from-rose-400 via-rose-500 to-rose-600 bg-clip-text text-transparent">
								Access The Selfbot Experience
							</span>
						</h2>
						<p className="text-rose-200/80 text-xl max-w-2xl mx-auto leading-relaxed">
							All plans include Regular updates, full Feature access, and zero-retention security
						</p>
					</motion.div>
						...
						{[
							{
								...
								productId: "282137",
								variantId: "292249",
								description: "Perfect for quick use",
								features: ["Instant access", "All Features", "Regular updates", "24/7 support"],
							...
							},
							{
								...
								features: ["Extended access", "All Features", "Regular updates", "24/7 support"],
							...
							},
							{
								...
								features: ["Full month access", "All Features + Beta Features", "Regular updates", "Priority support"],
							...
							},
							{
								...
								features: ["Yearly access", "All Features + Special ones", "Regular updates", "VIP support"],
								badge: "BEST VALUE",
							...
							{[
								{
									...
									description: "Your Tokens are never stored",
								},
								{
									icon: Database,
									stat: "Features",
									label: "Many unique features",
									description: "Largest Feature database",
								},
								{
									icon: Lock,
									stat: "100%",
									label: "Secure",
									description: "Protected By us",
								},
							].map((item, idx) => (
								<motion.div
									key={item.label}
				...
				<div className="max-w-7xl mx-auto">
					...
					>
						...
						<p className="text-rose-200/80 text-lg max-w-2xl mx-auto">
							We believe in making Selfbot tools accessible to those working for the greater good.
						</p>
					</motion.div>
					...
					<div className="grid md:grid-cols-2 gap-8">
						...
						<Card className="p-8 bg-rose-900/20 backdrop-blur-lg rounded-xl border border-rose-800/30 hover:border-rose-400/50 transition-all group hover:shadow-rose-500/20 hover:shadow-xl relative overflow-hidden">
							...
							<CardContent className="p-0 relative">
								...
								<p className="text-rose-200/90 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
									Join the community of journalists, researchers, and activists using Aromantic to make a difference. We
						...
						<Card className="p-8 bg-rose-900/20 backdrop-blur-lg rounded-xl border border-rose-800/30 hover:border-rose-400/50 transition-all group hover:shadow-rose-500/20 hover:shadow-xl relative overflow-hidden">
							...
							<CardContent className="p-0 relative">
								...
								<p className="text-rose-200/90 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
									Help expand our intelligence matrix by contributing domains. Get{" "}
					...
					>
						<div className="space-y-4">
							...
							<p className="text-rose-200/80 text-sm leading-relaxed">
								The definitive selfbot convergence platform with ephemeral sessions and zero data retention.
							</p>
						</div>
