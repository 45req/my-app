					...
					<CardContent className="p-6">
						<div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
							<div className="flex items-center gap-3">
								...
								<div>
									<h2 className="text-xl font-bold">Aromantic Intelligence Matrix</h2>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>Aromantic intelligence matrix scope</CardDescription>
						</CardHeader>
						<CardContent>
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>Your current Aromantic subscription</CardDescription>
						</CardHeader>
						<CardContent>
							...
							<div className="flex justify-center">
								<button
									onClick={() => (window.location.href = "https://Aromantic.sell.app/")}
				...
				<Card className="bg-black/10">
					<CardContent className="p-4">
						<div className="flex items-center gap-2">
							...
							<p className="text-xs text-muted-foreground">
								Aromantic operates with a strict no-logging policy. No search history or user activity is recorded.
							</p>
						</div>
					</CardContent>
				</Card>
