			...
			<div className="max-w-4xl mx-auto px-4 py-12">
				...
				>
					...
					<p className="text-rose-300/80 max-w-lg">
						Please read these terms carefully before using Aromantic. By accessing or using our service, you agree to be
				...
				>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						{[
							...
							},
							{
								...
								title: "Legal Use",
								desc: "You must use Aromantic for lawful purposes only",
							},
							{
					...
					>
						...
						<p className="text-rose-200/90 text-sm">
							<span className="font-semibold text-rose-300">Important:</span> Using Aromantic for illegal activities or in
				...
				>
					...
					<div className="space-y-4 text-rose-200/90 relative">
						<motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
							Aromantic grants you a personal, transferable, non-exclusive license to use our platform in accordance with
				...
				>
					...
					<div className="space-y-4 text-rose-200/90">
						<p>
							You agree to use Aromantic only for lawful purposes and in accordance with these Terms. Aromantic is designed
						...
						<p className="font-semibold text-rose-300">You expressly agree NOT to use Aromantic to:</p>
				...
				>
					...
					<div className="space-y-4 text-rose-200/90">
						<p>
							Aromantic is provided on an "as is" and "as available" basis. We make no warranties, expressed or implied,
							regarding the reliability, availability, or accuracy of the service or the data it provides.
						</p>
						<p>
							In no event shall Aromantic, its operators, or its data providers be liable for any indirect, incidental,
						...
						>
							...
							<p className="text-sm">
								We do not guarantee the completeness or accuracy of data provided through our service. Aromantic
				...
				>
					...
					<div className="space-y-4 text-rose-200/90">
						<p>
							Aromantic serves a community of security researchers, privacy advocates, and OSINT professionals. We expect
						...
						>
							...
							<div>
								...
								<p className="text-sm">
									We value privacy, security, and ethical conduct. Aromantic is designed for legitimate security research
			...
			<footer className="border-t border-rose-900/50 mt-12">
				<div className="max-w-7xl mx-auto px-4 py-8">
					<div className="flex flex-col md:flex-row justify-between items-center gap-4">
						<div className="text-rose-300/80 text-sm">© 2025 Aromantic. All rights reserved.</div>
