...
const partners = [
	{
		...
		characteristics: [
			{ icon: Database, text: "sample text" },
			{ icon: RefreshCw, text: "sample text" },
			{ icon: Zap, text: "sample text" },
			{ icon: Search, text: "sample text " },
		],
		mainFeature: "Sample Text",
			...
			<section className="relative min-h-[50vh] flex items-center justify-center px-4 pt-20 pb-10">
				<div className="relative z-10 text-center max-w-4xl mx-auto">
					...
					>
						...
						>
							AROMANTIC is powered by exclusive partnerships with{" "}
							<span className="text-rose-400 font-semibold">A</span>,{" "}
							<span className="text-rose-400 font-semibold">X</span>, and{" "}
							<span className="text-rose-400 font-semibold">B</span>. Their generous domains enables our
							comprehensive intelligence providing you with unparalleled SELFBOT capabilities.
						</motion.p>
										...
										>
											...
											<p className="relative text-rose-100 leading-relaxed bg-rose-500/10 p-4 rounded-lg border border-rose-500/20">
												{partner.name === "KeyScore" && (
													<>
														<span className="font-semibold">KeyScore</span> has provided AROMANTIC with exclusive,
												...
												{partner.name === "SELFBOTDog" && (
													<>
														<span className="font-semibold">SELFBOTDog</span> has integrated their powerful aggregation
														engine directly with Aromantic. providing us API access with a wide range of search types and
														all their features.
													</>
												)}
												{partner.name === "Rutify" && (
													<>
														<span className="font-semibold">Rutify</span> has granted AROMANTIC complete API access to
									...
									>
										<div className="flex items-start gap-3">
											...
											enhanced our platform's effectiveness.`}
												{partner.name === "SELFBOTDog" &&
													`SELFBOTDog's ever growing database has been a game-changer for our platform. Their exceptional
					...
					>
						...
						<div className="relative space-y-8 flex flex-col items-center text-center">
							...
							<motion.p
								...
								transition={{ delay: 0.3 }}
							>
								Join our exclusive network of intelligence providers and help build the most comprehensive SELFBOT
